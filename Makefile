...
GRAPHITE_FLAGS = -fgraphite -fmodulo-sched -fmodulo-sched-allow-regmoves -fipa-pta -floop-flatten -floop-parallelize-all -ftree-loop-linear -floop-interchange -floop-strip-mine -floop-block
